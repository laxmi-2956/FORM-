     ...
     <>
      ...
      <div className="box"></div>
       ...
       Email : <input style={{ padding : '6px 0px' , margin : '10px 0px' , fontSize : '20px'}} type="email" placeholder="email" onChange={(e)=>setemail(e.target.value)}  value={email}/>
        <br/>
       Password: <input style={{marginRight : '25px' , padding : '6px 0px' , margin : '10px 0px' , fontSize : '20px'}} type="password" placeholder="password" onChange={(e)=>setpassword(e.target.value)} value={password}/>
       <br />
